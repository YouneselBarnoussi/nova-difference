...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    diffHtmlOld: function diffHtmlOld() {
      return this.getDiffHtml(diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_DELETE);
    },
    diffHtmlNew: function diffHtmlNew() {
      return this.getDiffHtml(diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_INSERT);
    }
  },
  methods: {
    getDiffHtml: function getDiffHtml(diffType) {
      if (!this.field.oldValue || !this.field.newValue) {
        return '';
      }
      var dmp = new diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.diff_match_patch();
      var diffs = dmp.diff_main(JSON.stringify(this.field.oldValue, null, 2), JSON.stringify(this.field.newValue, null, 2));
      dmp.diff_cleanupSemantic(diffs);
      var html = [];
      for (var x = 0; x < diffs.length; x++) {
        var op = diffs[x][0]; // Operation (insert, delete, equal)
        var data = diffs[x][1]; // Text of change.
        if (op === diffType || op === diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_EQUAL) {
          var style = op === diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_INSERT ? 'background: #e6ffe6;' : op === diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_DELETE ? 'background: #ffe6e6;' : '';
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    linesRemoved: function linesRemoved() {
      return this.getLineCount(diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_DELETE, diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_EQUAL);
    },
    linesAdded: function linesAdded() {
      return this.getLineCount(diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_INSERT, diff_match_patch__WEBPACK_IMPORTED_MODULE_0__.DIFF_EQUAL);
    }
  },
  methods: {
    getLineCount: function getLineCount() {
      ...
      dmp.diff_cleanupSemantic(diffs);
      var count = 0;
      for (var _len = arguments.length, diffTypes = new Array(_len), _key = 0; _key < _len; _key++) {
        diffTypes[_key] = arguments[_key];
      }
      for (var x = 0; x < diffs.length; x++) {
        var op = diffs[x][0]; // Operation (insert, delete, equal)
...
var _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
  "class": "diff-title"
}, "Old Value"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
  "class": "diff-title"
}, "New Value")])], -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_1, [_hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", {
        "class": "diff diff-old",
        innerHTML: $options.diffHtmlOld
      }, null, 8 /* PROPS */, _hoisted_3), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", {
        "class": "diff diff-new",
        innerHTML: $options.diffHtmlNew
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Not available on form ")];
    }),
    _: 1 /* STABLE */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", _hoisted_1, " - " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.linesRemoved), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", _hoisted_2, " + " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.linesAdded), 1 /* TEXT */)]);
}
...
Nova.booting(function (app, store) {
  app.component('index-difference', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-difference', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-difference', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.removed[data-v-9e63f81a] {\n  color: red;\n}\n.added[data-v-9e63f81a] {\n  color: green;\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _var_www_html_nova_components_Difference_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/* harmony import */ var _var_www_html_nova_components_Difference_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_var_www_html_nova_components_Difference_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_FormField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_FormField_vue_vue_type_template_id_c023248a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/FormField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyoubar_difference"] = self["webpackChunkyoubar_difference"] || [];
